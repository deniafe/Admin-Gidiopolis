...
export const CreateUser = () => {
  ...
  const { users, setUsers } = useUserEventContext()
  ...
  const closeModal = async () => {
    ...
    const myModal = Modal.getInstance(document.getElementById("createUser"))
    setLoading(false)
    return myModal.hide()
  }
  ...
  const createUser = () => {
    setLoading(true)
    // Usage example:
    createNewUser(displayName, email, password, isEnabled)
    .then((user) => {
              ...
              >
                  <div className="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                      ...
                      <div className="relative flex-auto p-4 px-6" data-te-modal-body-ref>
                        ...
                        <p className="text-sm pb-6">Create a new user with name, email, password and status</p>
